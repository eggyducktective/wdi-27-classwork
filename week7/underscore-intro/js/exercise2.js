...
console.log('even or odd', groupedEvenOdd);

console.log('--------------------');
// - Get three random numbers out of ` numbers `

const random = _.sample(numbers, 3);
console.log('get 3 random numbers', random);
...
const sortById = _.sortBy(people, 'uid');
console.log(sortById);

// - Get an array of all of the uids in ` people `
const peopleUid = _.pluck(people, 'uid');
